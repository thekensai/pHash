...
extern "C"
{
__declspec(dllexport) int __stdcall ph_dct_imagehash(const char* file,ulong64 &hash);
}
 ...
 */
#ifdef HAVE_IMAGE_HASH
__declspec(dllexport) int __stdcall ph_hamming_distance(const ulong64 hash1,const ulong64 hash2);
